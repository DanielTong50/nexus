                ...
                >
                    {FEATURES.map((feature) => (
                        <motion.div key={feature.title} variants={itemVariants}>
                            <Card className="h-full border-slate-700 hover:border-slate-500 hover:shadow-lg transition-all duration-300 group bg-slate-900/50">
                                <CardContent className="p-6">
                                    <div className="w-12 h-12 rounded-xl bg-slate-800 flex items-center justify-center mb-4 group-hover:bg-white group-hover:text-black transition-colors">
